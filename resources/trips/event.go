...
type ItineraryEvent struct {
	...
	MainCategory        shared.Translation `json:"main_category" table:"translation" alias:"main_category" on:"main_category.parent_id = trip_itinerary_event.main_category_id and title.field = 'title'" embedded:"true"`
	SecondaryCategoryID string             `json:"secondary_category_id" db:"secondary_category_id"`
	SecondaryCategory   shared.Translation `json:"secondary_category" table:"translation" alias:"secondary_category" on:"secondary_category.parent_id = trip_itinerary_event.secondary_category_id and title.field = 'title'" embedded:"true"`
	CountryID           string             `json:"country_id" db:"country_id"`
	Country             shared.Translation `json:"country" table:"translation" alias:"country" on:"country.parent_id = trip_itinerary_event.country_id and title.field = 'title'" embedded:"true"`
	RegionID            string             `json:"region_id" db:"region_id"`
	Region              shared.Translation `json:"region" table:"translation" alias:"region" on:"region.parent_id = trip_itinerary_event.region_id and title.field = 'title'" embedded:"true"`
	CityID              string             `json:"city_id" db:"city_id"`
	City                shared.Translation `json:"city" table:"translation" alias:"city" on:"city.parent_id = trip_itinerary_event.city_id and title.field = 'title'" embedded:"true"`
